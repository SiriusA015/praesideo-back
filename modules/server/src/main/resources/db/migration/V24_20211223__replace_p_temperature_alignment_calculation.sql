DROP PROCEDURE p_temperature_alignment_calculation(integer,integer,integer,integer);

create or replace procedure public.p_temperature_alignment_calculation(companyId integer, startYear integer, recordType integer, isScenario integer)
    language plpgsql
as
$$
begin
...
insert into impact.t_impact_temperature_alignment (
    ...
    transition_pathway_overall_baseline_value,
...
values (
           ...
           244, -- Transition pathway overall
           240,
           230,
           100,
           0,
    ...
    ON CONFLICT (company_id, year, record_type, is_scenario) DO UPDATE SET year = startYear;
